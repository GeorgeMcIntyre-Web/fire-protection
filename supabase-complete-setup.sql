-- Fire Protection Tracker - Complete Database Setup
-- Run this entire script in your Supabase SQL Editor
-- This combines both the main setup and document management setup
...
-- ============================================
-- You now have:
-- - 6 core tables (profiles, clients, projects, tasks, time_logs, work_documentation)
-- - 3 document management tables (document_categories, document_library, project_documents)
-- - 9 pre-configured document categories
-- - 5 storage buckets
